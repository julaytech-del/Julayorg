...
const createDefaultRoles = async (orgId) => {
  const roles = [
    ...
    { name: 'Manager', level: 'manager', permissions: { projects: { create: true, read: true, update: true, delete: true }, tasks: { create: true, read: true, update: true, delete: true, assign: true }, users: { create: false, read: true, update: true, delete: false }, departments: { create: false, read: true, update: true, delete: false }, ai: { use: true, configure: false }, reports: { view: true, export: true } } },
