        ...
        MuiOutlinedInput: {
          styleOverrides: {
            root: {
              ...
              '&.Mui-focused .MuiOutlinedInput-notchedOutline': { borderColor: dark ? 'rgba(255,255,255,0.3)' : '#CBD5E1 !important', borderWidth: '1.5px' },
            }
          }
        },
        MuiInputLabel: {
          styleOverrides: {
            root: {
              '&.Mui-focused': { color: dark ? 'rgba(255,255,255,0.5)' : '#64748B' },
            }
          }
        },
        MuiMenu: {
